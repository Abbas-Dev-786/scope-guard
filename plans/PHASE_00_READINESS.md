...
**Status:** In progress | **Required:** Yes | **Depends on:** None  
**Owns:** R17; A21, A29  
...
- [ ] P00-04 Deploy the smallest frontend/Cognito/API path. Validate a server-derived owner identity and rejected unauthorized request; connect to private Aurora through the declared proxy/pool path with a bounded query.
...
- [ ] P00-09 Set reviewed model prices and explicit monetary/token limits before enabling analysis. Record estimated infrastructure cost drivers, operator-configured ceilings, database connection reserve and teardown/reset instructions.
...
P00-03 is complete. The local portions of P00-02, P00-04, P00-08 and P00-10 have evidence, and the us-east-1 AWS foundation stack now has deployed Cognito, private S3, KMS, EventBridge and encrypted logging resources. Their checkboxes remain open where private database connectivity, provider calls, model/runtime traces, cost approval and the complete cloud recreation have not been observed. P00-01, P00-05 through P00-07, and P00-09 require external account facts or an operator-approved model price/ceiling.
